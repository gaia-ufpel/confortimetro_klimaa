    ...
    <div className='flex flex-col justify-center items-center font-montserrat'>
      ...
      <form className='flex flex-col space-y-4 justify-center items-center p-10'>
        ...
        <div className='relative space-y-8 py-10'>
          ...
          <button className='absolute right-0 bottom-0 text-zinc-100 text-base font-semibold tracking-[0]'> Esqueci minha senha</button>
        </div>
        <button className='px-10 py-2 rounded-xl text-neutral-50 bg-[#885AC6] shadow-md border-2 border-green-300 font-extrabold text-2xl' onClick={sendCredentials}> Entrar </button>
      </form>
      <div className='flex flex-col space-y-10'>
        <button className='text-zinc-100 text-base font-semibold' onClick={() => { }}>Ainda não possui uma conta?</button>
